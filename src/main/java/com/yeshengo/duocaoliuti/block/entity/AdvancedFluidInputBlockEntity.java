...
public class AdvancedFluidInputBlockEntity extends BaseMultiSlotFluidHatchBlockEntity {
    private static final long CAPACITY_PER_SLOT = 16000;

    public AdvancedFluidInputBlockEntity(BlockPos pos, BlockState state) {
        super(new BEP(ModBlockEntities.ADVANCED_FLUID_INPUT_BE.get(), pos, state),
                new MachineGuiParameters.Builder("advanced_fluid_input", true).build(),
