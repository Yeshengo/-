...
public class AdvancedFluidOutputBlockEntity extends BaseMultiSlotFluidHatchBlockEntity {
    private static final long CAPACITY_PER_SLOT = 16000;

    public AdvancedFluidOutputBlockEntity(BlockPos pos, BlockState state) {
        super(new BEP(ModBlockEntities.ADVANCED_FLUID_OUTPUT_BE.get(), pos, state),
                new MachineGuiParameters.Builder("advanced_fluid_output", true).build(),
