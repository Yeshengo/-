...
public class SteelFluidInputBlockEntity extends BaseMultiSlotFluidHatchBlockEntity {
    private static final long CAPACITY_PER_SLOT = 8000;

    public SteelFluidInputBlockEntity(BlockPos pos, BlockState state) {
        super(new BEP(ModBlockEntities.STEEL_FLUID_INPUT_BE.get(), pos, state),
                new MachineGuiParameters.Builder("steel_fluid_input", true).build(),
