...
public class TurboFluidInputBlockEntity extends BaseMultiSlotFluidHatchBlockEntity {
    private static final long CAPACITY_PER_SLOT = 32000;

    public TurboFluidInputBlockEntity(BlockPos pos, BlockState state) {
        super(new BEP(ModBlockEntities.TURBO_FLUID_INPUT_BE.get(), pos, state),
                new MachineGuiParameters.Builder("turbo_fluid_input", true).build(),
