...
public class SteelFluidOutputBlockEntity extends BaseMultiSlotFluidHatchBlockEntity {
    private static final long CAPACITY_PER_SLOT = 8000;

    public SteelFluidOutputBlockEntity(BlockPos pos, BlockState state) {
        super(new BEP(ModBlockEntities.STEEL_FLUID_OUTPUT_BE.get(), pos, state),
                new MachineGuiParameters.Builder("steel_fluid_output", true).build(),
