...
public class EliteFluidOutputBlockEntity extends BaseMultiSlotFluidHatchBlockEntity {
    private static final long CAPACITY_PER_SLOT = 64000;

    public EliteFluidOutputBlockEntity(BlockPos pos, BlockState state) {
        super(new BEP(ModBlockEntities.ELITE_FLUID_OUTPUT_BE.get(), pos, state),
                new MachineGuiParameters.Builder("elite_fluid_output", true).build(),
